...
public class VdoPlayerControlView extends FrameLayout {
    ...
    private static final CharSequence[] allowedSpeedStrList = new CharSequence[]{"0.5x", "0.75x", "1x", "1.25x", "1.5x", "1.75x", "2x"};
    ...
    /**
     * Call if fullscreen is entered/exited in response to external triggers such as orientation
