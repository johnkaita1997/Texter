...
class FormThreeSubjectAdapter(var subjectlist: ArrayList<Subject>, private val mContext: Context) : RecyclerView.Adapter<FormThreeSubjectAdapter.SubjectHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubjectHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val view = layoutInflater.inflate(R.layout.custom_subjects_formthree, parent, false)
